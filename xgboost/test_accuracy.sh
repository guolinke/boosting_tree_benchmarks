...
xgboost/xgboost xgboost.conf tree_method=exact data="../data/allstate.train" eta=0.02 eval[test]="../data/allstate.test" objective="binary:logistic" eval_metric=auc 2>&1 | tee xgboost_allstate_accuracy.log
...
xgboost/xgboost xgboost.conf max_bin=255 tree_method=hist grow_policy=lossguide max_depth=0 max_leaves=255 data="../data/dataexpo_onehot.train" eval[test]="../data/dataexpo_onehot.test" objective="binary:logistic" eval_metric=auc 2>&1 | tee xgboost_hist_dataexpo_accuracy.log
xgboost/xgboost xgboost.conf max_bin=255 tree_method=hist grow_policy=lossguide max_depth=0 max_leaves=127 eta=0.02 data="../data/allstate.train" eval[test]="../data/allstate.test" objective="binary:logistic" eval_metric=auc 2>&1 | tee xgboost_hist_allstate_accuracy.log
